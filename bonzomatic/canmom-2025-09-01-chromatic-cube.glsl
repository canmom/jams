...
void main(void)
{
  ...
  float r = 5.0*texture(texFFTSmoothed,0.05).r;
  float r2 = 150.0*texture(texFFTSmoothed,0.1).r;
  
  vec3 theta = -vec3(texture(texFFTIntegrated, 0.1).r) + vec3(0.2, 0.1, 0.0)*r2;
